...
void SetROMwait(int freq,int CS0WCR_WR){
	...
	if ( ( freq >= MaxFreq_ROMwait[WAIT_1] ) && ( IWW0 == 0 ) )	BSC.CS0BCR.BIT.IWW = ( 1 ) ;	// IWW:1
	if ( ( freq >= MaxFreq_ROMwait[WAIT_3] ) && ( IWW0 <= 1 ) )	BSC.CS0BCR.BIT.IWW = ( 2 ) ;	// IWW:2
	if ( ( freq >= MaxFreq_ROMwait[WAIT_5] ) && ( IWW0 <= 2 ) )	BSC.CS0BCR.BIT.IWW = ( 3 ) ;	// IWW:4
	if ( ( freq >= MaxFreq_ROMwait[WAIT_8] ) && ( IWW0 <= 3 ) )	BSC.CS0BCR.BIT.IWW = ( 4 ) ;	// IWW:6
	if ( ( freq >= MaxFreq_ROMwait[WAIT10] ) && ( IWW0 <= 4 ) )	BSC.CS0BCR.BIT.IWW = ( 5 ) ;	// IWW:8
