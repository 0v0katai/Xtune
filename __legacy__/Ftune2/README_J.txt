===============================================================================
 ...
 copyright(c)2014/2015/2016/2017/2019-2020 by sentaro21
 e-mail sentaro21@pm.matrix.jp

===============================================================================

CASIOのfx-9860GII-2はSH7305と称されるSH4Aが採用されています。
...
-------------------------------------------------------------------------------
v1.40   2020.2.20	電池電圧表示がエミュレータでシステムエラーになる不具合を修正しました。
			"X"を乗算記号"x"に変更しました。

v1.20   2019.8.31	電池電圧表示値を補正しました。
