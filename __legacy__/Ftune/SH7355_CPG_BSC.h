/*---------------------------------------------------------------------------------------------
    ...
    SH7337/7355 CPG&BSC Register.

    for fx-9860G/II  v1.01
...
-------------------------------------------------------------------------------
        register structure for the BCR/WCR similar to SH7705.
...
---------------------------------------------------------------------------------------------*/
struct st_cpg {                       // struct CPG      similar to SH7705
    union {                           // FRQCR        
...
struct st_bsc {
    unsigned long CMNCR;
    union {                           // struct CS0BCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :2;    //              
            unsigned long IWW  :2;    //   IWW        
            unsigned long      :1;    //              
            unsigned long IWRWD:2;    //   IWRWD      
            unsigned long      :1;    //              
            unsigned long IWRWS:2;    //   IWRWS      
            unsigned long      :1;    //              
            unsigned long IWRRD:2;    //   IWRRD      
            unsigned long      :1;    //              
            unsigned long IWRRS:2;    //              
            unsigned long      :1;    //              
            unsigned long TYPE :3;    //   TYPE       
            unsigned long      :1;    //              
            unsigned long BSZ  :2;    //   BSZ        
            unsigned long      :9;    //              
            }   BIT;
        }   CS0BCR;
    union {                           // struct CS2BCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :2;    //              
            unsigned long IWW  :2;    //   IWW        
    ...
    union {                           // struct CS3BCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :2;    //              
            unsigned long IWW  :2;    //   IWW        
    ...
    union {                           // struct CS4BCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :2;    //              
            unsigned long IWW  :2;    //   IWW        
    ...
    union {                           // struct CS5ABCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :2;    //              
            unsigned long IWW  :2;    //   IWW        
    ...
    union {                           // struct CS5BBCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :2;    //              
            unsigned long IWW  :2;    //   IWW        
    ...
    union {                           // struct CS6ABCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :2;    //              
            unsigned long IWW  :2;    //   IWW        
    ...
    union {                           // struct CS6BBCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :2;    //              
            unsigned long IWW  :2;    //   IWW        
    ...
    union {                           // struct CS0WCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :13;   //              
    ...
    union {                           // struct CS2WCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :13;   //              
            unsigned long WW   :3;    //    WW  
    ...
    union {                           // struct CS3WCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :13;   //              
            unsigned long WW   :3;    //    WW  
    ...
    union {                           // struct CS4WCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :13;   //              
            unsigned long WW   :3;    //    WW  
    ...
    union {                           // struct CS5AWCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :13;   //              
            unsigned long WW   :3;    //    WW  
    ...
    union {                           // struct CS5BWCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :13;   //              
            unsigned long WW   :3;    //    WW  
    ...
    union {                           // struct CS6AWCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :13;   //              
            unsigned long WW   :3;    //    WW  
    ...
    union {                           // struct CS6BWCR   similar to SH7705
        unsigned long LONG;           // long Word Access
        struct {                      // Bit  Access
            unsigned long      :13;   //              
            unsigned long WW   :3;    //    WW  
...
#define BSC    (*(volatile struct st_bsc   *)0xA4FD0000)    // CMNCR Address
